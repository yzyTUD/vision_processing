...
namespace cgv {
	...
	namespace pointcloud {
		...
		public:
			...
			void reg_icp_get_matrices_from_4pair_points(std::vector<Pnt>* clicking_points_src, std::vector<Pnt>* clicking_points_target, Mat& rmat_accu, Dir& tvec_accu);
			void reg_icp_get_matrices(point_cloud* pc_src, point_cloud* pc_target, point_cloud& S, point_cloud& Q, Mat& rmat, Dir& tvec);
