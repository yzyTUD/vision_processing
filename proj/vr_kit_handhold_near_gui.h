...
class vr_kit_handhold_near_gui :
...
public:
	...
	vr_kit_handhold_near_gui()
	{
		//connect(get_animation_trigger().shoot, this, &vr_kit_handhold_near_gui::timer_event);		
	...
	{
		return "vr_kit_handhold_near_gui";
	}
